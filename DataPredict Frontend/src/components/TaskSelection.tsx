...
export function TaskSelection() {
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <div className="mb-6">
        <h2 className="page-title">Configuration de la tâche</h2>
        <p className="text-gray-500 dark:text-slate-400">Définissez vos objectifs d'apprentissage automatique</p>
      </div>
