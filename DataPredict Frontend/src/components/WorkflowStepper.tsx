...
export function WorkflowStepper() {
    ...
    return (
        <div className={`border-b transition-colors duration-300 px-6 py-4 mb-6 sticky top-0 z-20 ${isDarkMode ? 'bg-[#1e293b] border-[#334155]' : 'bg-white border-gray-200'}`}>
            <div className="max-w-6xl mx-auto flex items-center justify-between overflow-x-auto no-scrollbar gap-4 py-1">
                ...
                `}>
                  ...
                  `}>
                    ...
                    ${isActive ? (isDarkMode ? 'text-blue-400' : 'text-gray-900') : isCompleted ? (isDarkMode ? 'text-gray-300' : 'text-gray-700') : (isDarkMode ? 'text-gray-500' : 'text-gray-500')}
                  `}>
                                        {step.label}
                                    </span>
                                </div>
            ...
            <div className={`max-w-6xl mx-auto flex justify-end mt-4 pt-4 border-t transition-colors duration-300 ${isDarkMode ? 'border-gray-700' : 'border-gray-100'}`}>
                <button
                    onClick={handleReset}
