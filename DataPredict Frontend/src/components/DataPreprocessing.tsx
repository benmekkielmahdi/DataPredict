...
export function DataPreprocessing() {
  ...
  return (
    <div className="p-6 max-w-5xl mx-auto">
      <div className="mb-6">
        <h2 className="page-title">Prétraitement des données</h2>
        <p className="text-gray-500 dark:text-slate-400">Configurez les étapes de préparation de vos données</p>
      </div>
