    ...
    <div className="space-y-6">
      <div className="flex justify-between items-start">
        <div>
          ...
          <p className="text-gray-500 dark:text-slate-400">Bienvenue sur DataPredict</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="card">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <div className="text-2xl font-bold text-gray-900 -white">{Math.floor(stats.modelsTrained / 2)}</div>
