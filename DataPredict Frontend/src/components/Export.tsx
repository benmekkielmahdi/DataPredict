    ...
    return (
        <div className="p-6 max-w-6xl mx-auto">
            <div className="mb-8 flex items-center justify-between">
                <div>
                    <h1 className="page-title">Exportation du modèle</h1>
                    <p className="text-gray-500 dark:text-slate-400">Exportez votre modèle <span className="font-bold text-blue-600 dark:text-blue-400">XGBoostClassifier</span> au format standard H5</p>
                </div>
                <button
            ...
            <div className="flex justify-center mb-8">
                {exportOptions.map((option) => {
                    ...
                    return (
                        <div
                            key={option.format}
                            className="relative bg-white dark:bg-slate-800 rounded-2xl p-8 border-2 border-blue-100 dark:border-blue-900/50 shadow-xl shadow-blue-50 dark:shadow-blue-900/20 max-w-lg w-full transform transition-all hover:scale-[1.02]"
                        >
                            ...
                            <div className="flex flex-col items-center text-center">
                                ...
                                <h3 className="text-2xl font-black text-gray-900 dark:text-white mb-2">{option.title}</h3>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 rounded-xl p-6 border border-blue-200 dark:border-blue-800/50">
                <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-4">Informations du modèle</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="bg-white dark:bg-slate-800 rounded-lg p-4">
                        <div className="text-sm text-gray-600 dark:text-slate-400 mb-1">Nom du modèle</div>
                        <div className="text-lg font-bold text-gray-900 dark:text-white">{bestModel}</div>
                    </div>
                    <div className="bg-white dark:bg-slate-800 rounded-lg p-4">
                        <div className="text-sm text-gray-600 dark:text-slate-400 mb-1">Date d'entraînement</div>
                        <div className="text-lg font-bold text-gray-900 dark:text-white">{new Date().toLocaleDateString('fr-FR')}</div>
                    </div>
                    <div className="bg-white dark:bg-slate-800 rounded-lg p-4">
                        <div className="text-sm text-gray-600 dark:text-slate-400 mb-1">Taille estimée</div>
                        <div className="text-lg font-bold text-gray-900 dark:text-white">2.4 MB</div>
                    </div>
                    <div className="bg-white dark:bg-slate-800 rounded-lg p-4">
                        <div className="text-sm text-gray-600 dark:text-slate-400 mb-1">Version</div>
                        <div className="text-lg font-bold text-gray-900 dark:text-white">1.0.0</div>
                    </div>
                </div>
            </div>
