...
export function ModelRecommendation() {
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto">
      <div className="mb-6">
        <h2 className="page-title">Recommandation de modèle IA</h2>
        <p className="text-gray-500 dark:text-slate-400">Notre IA a analysé vos données et recommande ces modèles</p>
      </div>
