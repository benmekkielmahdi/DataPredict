...
export function History() {
    ...
    return (
        <div className="p-6 max-w-7xl mx-auto">
            {/* Header */}
            <div className="mb-8">
                <h1 className="page-title">Historique des entraînements</h1>
                <p className="text-gray-500 dark:text-slate-400">Consultez et comparez vos expériences passées</p>
            </div>
                                ...
                                >
                                    ...
                                    <td className="px-6 py-4 text-center">
                                        <button
                                            onClick={(e) => {
                                                e.stopPropagation();
                                                navigate(`/visualization/${record.id}`);
                                            }}
