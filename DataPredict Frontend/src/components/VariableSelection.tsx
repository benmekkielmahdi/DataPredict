  ...
  if (!featureSelectionResult) {
    return (
      <div className="p-6 max-w-4xl mx-auto bg-white -slate-800 min-h-screen">
        <div className="mb-6">
          <h2 className="page-title">Sélection de la variable cible</h2>
          <p className="text-gray-500 dark:text-slate-400">Choisissez la variable que vous souhaitez prédire ou classifier.</p>
        </div>
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto">
      <div className=" mb-6 flex items-center justify-between">
        <div>
          <h2 className="page-title">Résultats de la sélection des features</h2>
          <p className="text-gray-500 dark:text-slate-400">
            Analyse effectuée pour la cible : <span className="font-semibold text-blue-600 dark:text-blue-400">{targetVariable}</span>
          </p>
        </div>
